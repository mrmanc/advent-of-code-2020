let passportData = ["eyr:2028 iyr:2016 byr:1995 ecl:oth",
...
passportData.forEach(line => {
    if (line === "") {
        let allFieldsPresent = requiredFields.every(field => currentPassportData.has(field));
        let allFieldsValid = true;
        currentPassportData.forEach((value, key) => {
